...
class Validate<T> implements LoginState<T> {
...
@override
String toString() {
  return 'LoginState<$T>.passwordValidate(hasLowerCase: $hasLowerCase, hasUpperCase: $hasUpperCase, hasMinLength: $hasMinLength, hasNumber: $hasNumber, hasSpecialCharacters: $hasSpecialCharacters)';
}
...
/// @nodoc
abstract mixin class $ValidateCopyWith<T,$Res> implements $LoginStateCopyWith<T, $Res> {
